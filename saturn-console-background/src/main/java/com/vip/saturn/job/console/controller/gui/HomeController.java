...
public class HomeController extends AbstractGUIController {
    ...
    public ResponseEntity<RequestResult> getNamespace(final HttpServletRequest request, @PathVariable("namespace") String namespace) throws SaturnJobConsoleHttpException {
