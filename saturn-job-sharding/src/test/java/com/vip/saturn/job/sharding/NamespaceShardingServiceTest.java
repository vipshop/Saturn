...
public class NamespaceShardingServiceTest {
    ...
    public void leadershipElectionTest() throws Exception {
        ...
        NamespaceShardingManager namespaceShardingManager1 = new NamespaceShardingManager(curatorFramework1, namespace, ip1);
        ...
        NamespaceShardingManager namespaceShardingManager2 = new NamespaceShardingManager(curatorFramework2, namespace, ip2);
        ...
        NamespaceShardingManager namespaceShardingManager3 = new NamespaceShardingManager(curatorFramework3,namespace, ip3);
