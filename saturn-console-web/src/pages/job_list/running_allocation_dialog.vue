        ...
        <el-form label-width="190px">
            ...
            <el-form-item>
                <div slot="label">
                    ...
                    <el-tooltip placement="top" content="作业状态未上报，例如消息作业，秒级作业，无法获知运行状态" effect="light" popper-class="allocation-popper">
                ...
                <el-col :span="22">
                    ...
                    <div v-else>
                        <el-tag class="form-tags" type="" v-for="item in Object.entries(runningAllocationInfo.potentialRunningJobItems)" :key="item[0]">{{item[0]}} : {{item[1]}}</el-tag>
                    </div>
                </el-col>
            </el-form-item>
        </el-form>
