                    ...
                    <Panel type="warning" class="job-alarm-panel">
                        ...
                        <div slot="content">
                            <div class="job-alarm-content">
                                ...
                                <div class="panel-btn"><el-button size="small" type="warning" @click="handleAbnormalJob()">不再告警</el-button></div>
                            </div>
                        </div>
                    </Panel>
                </el-col>
                    ...
                    <Panel type="warning" class="job-alarm-panel">
                        ...
                        <div slot="content">
                            <div class="job-alarm-content">
                                ...
                                <div class="panel-btn"><el-button size="small" type="warning" @click="handleTimeoutJob()">不再告警</el-button></div>
                            </div>
                        </div>
                    </Panel>
                </el-col>
...
export default {
  ...
  methods: {
    ...
    handleAbnormalJob() {
      this.$http.post('/console/zkClusters/alarmStatistics/setAbnormalJobMonitorStatusToRead', { uuid: this.abnormalJob.uuid }).then(() => {
        this.init();
    ...
    handleTimeoutJob() {
      this.$http.post('/console/zkClusters/alarmStatistics/setTimeout4AlarmJobMonitorStatusToRead', { uuid: this.timeoutJob.uuid }).then(() => {
        this.init();
        this.$message.successNotify('操作成功');
      })
      .catch(() => { this.$http.buildErrorHandler('不再告警操作请求失败！'); });
