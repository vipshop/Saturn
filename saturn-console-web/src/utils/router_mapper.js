const routermapperlist = [
    ...
    { name: 'namespaceDisabledTimeoutJobs', path: '/job_list/:domain/namespace_alarm_center/namespace_disabled_timeout_jobs' },
    ...
    { name: 'alarmDisabledTimeoutJobs', path: '/alarm_manage/alarm_disabled_timeout_jobs' },
