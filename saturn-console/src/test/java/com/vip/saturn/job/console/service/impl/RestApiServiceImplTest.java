...
public class RestApiServiceImplTest extends AbstractSaturnConsoleTest {
    ...
    public void testRunAtOnceSuccessfully() throws SaturnJobConsoleException {
        ...
        //verify
        verify(jobOperationService).runAtOnceByJobnameAndExecutorName(jobName, jobServer.getExecutorName(), curatorFrameworkOp);
    }
    ...
    public void testRunAtOnceFailAsJobStatusIsNotReady() throws SaturnJobConsoleException {
        ...
        //verify
        verify(jobOperationService, times(0)).runAtOnceByJobnameAndExecutorName(anyString(), anyString(), any(CuratorRepository.CuratorFrameworkOp.class));
    }
    ...
    public void testStopAtOnceSuccessfullyWhenJobIsAlreadyStopped() throws SaturnJobConsoleException {
        ...
        //verify
        verify(jobOperationService, times(0)).stopAtOnceByJobnameAndExecutorName(anyString(), anyString(), any(CuratorRepository.CuratorFrameworkOp.class));
    }
    ...
    public void testStopAtOnceSuccessfullyWhenJobStatusIsStoppingAndJobTypeIsMsg() throws SaturnJobConsoleException {
        ...
        when(jobDimensionService.getJobType(jobName, curatorFrameworkOp)).thenReturn(JobBriefInfo.JobType.MSG_JOB.name());
        ...
        //verify
        verify(jobOperationService).stopAtOnceByJobnameAndExecutorName(jobName, jobServer.getExecutorName(), curatorFrameworkOp);
    }
    ...
    public void testStopAtOnceSuccessfullyWhenJobStatusIsStoppingAndJobTypeIsJava() throws SaturnJobConsoleException {
        ...
        when(jobDimensionService.getJobType(jobName, curatorFrameworkOp)).thenReturn(JobBriefInfo.JobType.JAVA_JOB.name());
    ...
    public void testStopAtOnceFailForMsgJobAsJobIsEnable() throws SaturnJobConsoleException {
        ...
        //verify
        verify(jobOperationService, times(0)).stopAtOnceByJobnameAndExecutorName(jobName, jobServer.getExecutorName(), curatorFrameworkOp);
    }
