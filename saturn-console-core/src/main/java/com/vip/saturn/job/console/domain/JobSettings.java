...
public final class JobSettings extends JobConfig {
	...
	public String updateFields() {
    	...
    	sb.append("{")
    		...
    		.append("jobType=").append(getJobType()).append(", ")
    		...
    		.append("preferList=").append(getPreferList()).append(", ")
    		.append("useDispreferList=").append(getUseDispreferList()).append(", ")
    		.append("localMode=").append(getLocalMode()).append(", ")
    		.append("preferListCandidate=").append(getPreferListCandidate()).append(", ")
    		.append("showNormalLog=").append(getShowNormalLog()).append(", ")
    		.append("useSerial=").append(getUseSerial())
    		.append("}");
    	return sb.toString();
    }
